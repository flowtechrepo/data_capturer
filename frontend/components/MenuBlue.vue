...
.menuContainerBlue .el-menu-item,.menuContainerBlue .el-submenu {
  cursor: pointer;
  font-weight: normal;
  font-size: 16px;
  color: $menuTitleColorBlue!important;
  .el-submenu__title {
    color: $menuTitleColorBlue!important;
    font-size: 16px;
    border: 0!important;
  ...
  &.is-active {
    ...
    a {
      color: $menuTitleColorBlue;
      &:after {
        background: $menuTitleColorBlue;
      }
    }
    .el-submenu__title {
      color: $menuTitleColorBlue!important;
...
.el-menu--popup .el-menu-item {
  ...
  &:hover {
    // background: $menuTitleColorBlue!important;
    font-weight: 600;
    a {
      color: #fff!important;
    }
